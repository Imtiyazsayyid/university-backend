...
// Dashboard
router.route("/admin-dashboard/analyticalData").get(adminController.getAnalyticalData);
router.route("/students/gender").get(adminController.getStudentGenderCount);
